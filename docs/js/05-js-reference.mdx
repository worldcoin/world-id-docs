...
The `actionId` and `signal` parameters must be ABI-encoded when passed to the JS package. Generally any parameters you use in a web3 app that interacts with the blockchain will be ABI-encoded, but you can also find a few examples below, as well as a simple tool to help you encode your parameters correctly.
...
Type any value below and select the type of value to generate the ABI-encoded result. You can use this helper to generate your own `actionId`. We recommend you generate this dynamically for `signal`s as these will change dynamically.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        Read more about the{" "}
        <Link to="/docs/about/glossary#uniqueness-hash">uniqueness hash</Link>.
      </td>
    </tr>
    <tr>
      <td>
