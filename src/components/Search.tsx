	...
	return (
		<div className={clsx('hidden lg:block lg:max-w-md lg:flex-auto', className)}>
			<button
				...
				{...buttonProps}
				className={clsx(
					'hidden h-8 w-full items-center gap-2 rounded-lg bg-white pl-2 pr-3 text-sm text-AG1 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 dark:bg-white/5 dark:text-zinc-400 dark:ring-inset dark:ring-white/10 dark:hover:ring-white/20 lg:flex focus:[&:not(:focus-visible)]:outline-none',
					buttonClassName
				)}
			>
				<SearchIcon className="h-5 w-5 stroke-current" />
				{placeholder ?? 'Find something...'}
				<kbd className="ml-auto text-2xs text-AG2 dark:text-zinc-500">
