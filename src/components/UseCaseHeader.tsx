...
export const UseCaseHeader = (props: { color: string; image: string; title: string; description: string }) => {
	return (
		<div className="flex flex-col items-center">
			...
			<h1 className="m-0 mt-3 font-bold text-5xl text-center">{props.title}</h1>
