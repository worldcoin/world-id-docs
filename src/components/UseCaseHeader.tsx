    ...
    <div className="flex flex-col items-center">
      ...
      >
        <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <radialGradient id="paint0_radial_320_10358" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(3.49669 -19.0526) rotate(55.0103) scale(140.436 139.83)">
