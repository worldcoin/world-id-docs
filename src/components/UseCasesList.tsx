    ...
    <div>
      ...
      <div className="mt-2 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <UseCasesListItem
          ...
          icon={(
            <>
              <path d="M26.7807 23.4492H20.8666C18.9474 23.4492 17.3916 25.005 17.3916 26.9242V30.6007C17.3916 32.5199 18.9474 34.0756 20.8666 34.0756H26.7807C28.6998 34.0756 30.2556 32.5199 30.2556 30.6007V26.9242C30.2556 25.005 28.6998 23.4492 26.7807 23.4492Z" fill="white"/>
              <path d="M20.4967 19.6396C21.6077 19.6396 22.6272 19.9357 23.4306 20.4305C23.6485 20.5646 23.9253 20.5646 24.1433 20.4305C24.9457 19.9357 25.9661 19.6396 27.0772 19.6396C28.061 19.6396 28.9743 19.8721 29.7275 20.2685C30.257 20.5472 30.8637 20.0746 30.7219 19.493C29.9638 16.3836 27.1601 14.0757 23.8173 14.0757C20.4745 14.0757 17.6968 16.3634 16.9243 19.4506C16.7796 20.0293 17.3776 20.5057 17.91 20.2357C18.6507 19.8595 19.5399 19.6396 20.4967 19.6396Z" fill="white"/>
              <path d="M23.8232 24.3907V19.1421" stroke="white" strokeWidth="0.781214" strokeMiterlimit="10"/>
              <path d="M28.5352 24.4087L30.3464 19.6992" stroke="white" strokeWidth="0.791823" strokeMiterlimit="10"/>
              <path d="M19.1277 24.436L17.3164 19.7266" stroke="white" strokeWidth="0.791823" strokeMiterlimit="10"/>
              <path d="M22.0381 25.7671H25.6095" stroke="white" strokeWidth="0.781214" strokeLinecap="round" strokeLinejoin="round"/>
            </>
          )}
      ...
      <h2 className="m-0 mt-12 font-bold text-xl text-black text-center">
        Join Worldcoin builder community
      </h2>
      ...
      <div className="mt-6 text-2xs text-black/50 text-center">
        *as World ID is a fully open protocol and anyone can build their own implementations, it is not possible to have numbers on all usage and holders.
      </div>
    </div>
  )
}
