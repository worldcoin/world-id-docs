...
We are committed to preserving each user's privacy and anonymity, collecting as little information as possible from our users. More on Worldcoin's commitment to privacy in <a href="https://worldcoin.org/privacy-by-design" target="blank">this blog post</a>.
