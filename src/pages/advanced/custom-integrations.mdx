...
<Callout type="tip">
  ...
  through the [Worldcoin Simulator](https://simulator.worldcoin.org).
</Callout>
...
<GradientBorderContainer defaultBackground className="w-full flex justify-center not-prose p-6">
  <img
