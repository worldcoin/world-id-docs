...
The Sign In widget is a wrapper around the [IDKit Widget](/reference/idkit/widget) that implements the OIDC imlpicit flow for Sign In with Worldcoin. It is a modal that opens when the user clicks the Sign In button.
