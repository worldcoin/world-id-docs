...
However, if your users will be performing [Dynamic Actions](/anonymous-actions/idkit#dynamic-actions), you should accept the action as a parameter to your contract's functions, and set it in the function body.
