...
We recommend including this helper function in your smart contract. It properly computes the `keccak256` hash used by Semaphore, and is frequenty used in the example code below.
