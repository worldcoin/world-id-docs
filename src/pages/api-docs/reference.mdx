...
<table>
    ...
    <tbody>
        <tr>
            <td>`signal`</td>
            <td>The signal you provided to the JS widget when verifying.</td>
            <td>`string`</td>
        </tr>
        <tr>
            <td>`action_id`</td>
            <td>The ID of the action you are verifying.</td>
            <td>`string`</td>
        </tr>
        <tr>
            <td>`nullifier_hash`</td>
            <td>As verbatim provided by the JS widget. See [JS response](/js-docs/reference#response) for details.</td>
            <td>`string`</td>
        </tr>
        <tr>
            <td>`merkle_root`</td>
