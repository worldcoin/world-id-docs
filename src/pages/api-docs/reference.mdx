...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        As verbatim provided by the IDKit. See [IDKit response](/idkit/reference#response) for details.
      </td>
      <td>`string`</td>
    </tr>
    <tr>
      <td>`merkle_root`</td>
      <td>
        As verbatim provided by the JS widget. See [IDKit response](/idkit/reference#response) for details.
      </td>
      <td>`string`</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Credential type used for the verification. Obtained from [IDKit response](/idkit/reference#response).</td>
      <td>`orb | phone`</td>
    </tr>
  </tbody>
</table>
