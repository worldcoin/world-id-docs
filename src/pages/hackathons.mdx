...
<img
  src="/images/docs/hackathons/eth-india-22.png"
  alt="ETHIndia logo"
  width="600px"
/>

Join us from December 2 to December 4, 2022 in Bengaluru, India. **🤑 $20,000 in Worldcoin
prizes are up for grabs**. Visit the [official website](https://ethindia.co)
to apply to hack.

<Callout type="tip">
  **Visit our [Event page](/ethindia)** to get details on workshops, resources,
...
<img
  src="/images/docs/hackathons/eth-sf-22.png"
  alt="ETHSanFrancisco logo"
  width="600px"
/>

From November 4 to November 6, 2022 in the Bay Area. **🤑 $20,000 in Worldcoin
prizes were up for grabs**. Visit the [official website](https://sf.ethglobal.com/) to see what everyone built.
...
This hackathon ran from October 7 to October 9, 2022 in the capital of Colombia. **🤑 $20,000 in Worldcoin prizes were up for grabs**. Visit the [official website](https://bogota.ethglobal.com/) to apply to hack.

Visit the [project showcase](https://showcase.ethglobal.com/ethbogota) to see what everyone built and Worldcoin prize winners.
