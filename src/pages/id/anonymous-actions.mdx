...
You can create _anonymous actions_ to verify any arbitrary action a user might take in your app, where each action is independent of other actions. Some examples include:
