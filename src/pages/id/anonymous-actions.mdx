...
Anonymous actions can either be configured via the developer portal, or on-the-fly as the user is verifying via the World app. Either approach provides the same featureset.
