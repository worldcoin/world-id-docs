...
<Note>
    ...
    **Cloud actions** natively handle sybil-resistance with a limit set in the Developer Portal.
    For **on-chain** use cases, you can track this nullifier hash in your smart contract to [implement sybil-resistance](/id/on-chain#sybil-resistance).
</Note>
...
<Note type="warning">
    ...
    Proceed to the [Cloud](/id/cloud) or [On-Chain](/id/on-chain) sections to learn how to verify proofs.
</Note>