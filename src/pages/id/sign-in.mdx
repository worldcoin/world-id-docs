...
### Required attributes
    ...
    <Properties>
      ...
      <Property name="nullifier_hash" type="string">
        The ZKP's nullifier hash, as returned by [IDKit](/idkit).
      </Property>
      <Property name="proof" type="string">
        The zero-knowledge proof, as returned by [IDKit](/idkit).
      </Property>
      <Property name="merkle_root" type="string">
        The ZKP's Merkle root, as returned by [IDKit](/idkit).
      </Property>
...
curl -X POST https://id.worldcoin.org/token \
     -H "Authorization: Basic YXBwX3N0YWdpbmdfNzU1MGU4MjkwODJmYzU1OGUxMTJlMDYyMGMxYzdhNT..." \
...
-H "Authorization: Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6Imp3a18yZmViZjY3MDc3N2UyY2NlN..."
```
