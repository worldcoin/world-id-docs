...
Upon successful completion of the World ID flow, you will receive a response object. The response object will contain the following attributes. **Normally, you will forward these parameters to your backend or smart contract for verification.**
