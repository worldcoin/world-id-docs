...
<Note title="FYI">
	...
	[feedback](https://discord.gg/worldcoin). Join the waitlist SDK [here](https://toolsforhumanity.typeform.com/sdk-waitlist).
</Note>
...
World ID unlocks a vast number of applications and use cases. You can find a list of community-curated ideas [here](https://worldcoin.notion.site/World-ID-df11c0d2a42b4890a1e9e8d15b9f550f).
