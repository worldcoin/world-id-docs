...
<h1 className='sm:text-5xl text-3xl'>Worldcoin Developer Docs</h1>
...
<span className="grid lg:grid-flow-col gap-x-8 mt-10 sm:grid-cols-3">
    ...
    <Card alt="World Chain" title={"Integrate World Chain"} content="A chain for humans. More details coming soon" link="#" imagePath="/images/docs/worldchain-cover.png"/>
</span>