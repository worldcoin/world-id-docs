...
<span className="grid lg:grid-flow-col gap-x-8 mt-10 sm:grid-cols-3">
    ...
    <Card alt="External Integrations" title={"Integrate World ID"} content="Simple, private, and secure proof of humanity" link="/world-id" imagePath="/images/docs/world-id-cover.png"/>
