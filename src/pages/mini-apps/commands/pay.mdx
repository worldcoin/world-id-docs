...
Note for convenience, we offer a public endpoint to query the current price of 1 WLD in various currencies detailed <Link href="/mini-apps/reference/api#get-prices">here</Link>. 
