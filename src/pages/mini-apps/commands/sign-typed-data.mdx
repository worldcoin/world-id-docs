...
> 💡 **Note:** The `domain` must match the Safe’s EIP-712 domain, as user wallets are [Safe](https://safe.global/) smart contract wallets.
  ...
  <TabItem label="Async handlers">
    ...
    import { MiniKit, SignTypedDataInput } from '@worldcoin/minikit-js'
      ...
      const signAndVerifyTypedData = async () => {
        ...
        // Verifying the signature. Note permit2 payloads and SafeTx operations are not permitted in this command.
