...
1. <Link href="/mini-apps/more/guidelines#safety" aria-label="Home">Safety</Link>
2. <Link href="/mini-apps/more/guidelines#legal" aria-label="Home">Legal</Link>
3. <Link href="/mini-apps/more/guidelines#app-submission" aria-label="Home">App Submission</Link>
4. <Link href="/mini-apps/more/guidelines#app-review" aria-label="Home">App Review</Link>
5. <Link href="/mini-apps/more/guidelines#technical-requirements" aria-label="Home">Technical Requirements</Link>
6. <Link href="/mini-apps/more/guidelines#user-support" aria-label="Home">User Support</Link>
...
- **Privacy:**
    ...
    - **Data Minimisation:** Apps should only request access to data that is relavent to how the app functions
