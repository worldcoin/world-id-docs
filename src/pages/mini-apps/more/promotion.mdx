...
We actively consider applications from all verticals and use cases. While there are many factors that go into picking each app, ultimately, we pick the apps that uphold a high quality bar and we think will delight users. 

**Useful:** We care deeply about our mission and apps that provide value leveraging both World ID and WLD. 

**Creative:** Uses our technology in interesting ways to create meaningful utility for our users

**Localisation:** Worldcoin is a global project with users all around the world. Featured apps should support well localized content for our global audience

**Design:** We place a high emphasis on thoughtful and beautifully designed interfaces and app store pages. 

**User Experience:** Apps should be highly functional, intuitive, and delightful to use
