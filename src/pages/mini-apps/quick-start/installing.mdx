...
-   [NextJS template (OLD)](https://github.com/new?template_name=minikit-next-template&template_owner=worldcoin).
-   [NextJS template (using wallet auth)](https://github.com/new?template_name=wld-mini-apps-101&template_owner=wlding-blocks).
