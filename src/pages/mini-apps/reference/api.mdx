...
## Create Incognito Action {{ tag: "POST", label: "https://developer.worldcoin.org/api/v2/create-action" }}
...
<Row>
    ...
    <Col>
        <CodeGroup title="Request" tag="POST" label="https://developer.worldcoin.org/api/v2/create-action">
            ```bash {{ title: "cURL" }}
            curl -X POST "https://developer.worldcoin.org/api/v2/create-action" \
                -H "Authorization: Bearer {api_key}" \
                -H "Content-Type: application/json" \
                -d '{
                    "action": "action_id",
    ...
    <Col>
        <Properties>
            ...
            The result object containing:
                ...
                - `external_nullifier` (string): The external nullifier of the action.
                - `action`,`name`,`description`,`max_verifications` (object): Properties of the action that was created.
            </Property>
        </Properties>
    </Col>
     <Col>
        <CodeGroup title="Response" tag="POST" label="https://developer.worldcoin.org/api/v2/create-action">
            ```json
            {
                "action": {
                    "action": "action",
