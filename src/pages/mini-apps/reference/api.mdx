...
## Get Transaction{{ tag: "GET", label: "/api/v2/minikit/transaction/{transaction_id}?app_id=&type=" }}
...
<Row>
    <Col>
     ...
     <Col>
        <CodeGroup title="Response" tag="GET" label="/api/v2/minikit/transaction/{transaction_id}?app_id=&type=">
            ```json {{ title: "Payment" }}
            {
...
## Get Prices {{ tag: "GET", label: "https://app-backend.toolsforhumanity.com/public/v1/miniapps/prices?cryptoCurrencies=WLD,USDCE&fiatCurrencies=" }}
...
We offer this as a service to make it easier to use WLD as a currency.
    ...
    <Col>
        <CodeGroup title="Request" tag="GET" label="https://app-backend.toolsforhumanity.com/public/v1/miniapps/prices?cryptoCurrencies=WLD,USDCE&fiatCurrencies=">
            ```bash {{ title: "cURL" }}
            curl -X GET "https://app-backend.toolsforhumanity.com/public/v1/prices/latest/wld?fiatCurrencies=USD"
            ```
            ```js
            fetch(apiUrl, {
                method: 'GET',
...
<Row>
    <Col>
     ...
     <Col>
        <CodeGroup title="Response" tag="GET" label="https://app-backend.toolsforhumanity.com/public/v1/miniapps/prices?cryptoCurrencies=WLD,USDCE&fiatCurrencies=">
            ```json
            {
                "result": {
                    "prices": {
