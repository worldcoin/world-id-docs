...
In short, you can create a quick action for you own mini app to share it with other developers or use other mini app quick actions that will be listed in this page.
