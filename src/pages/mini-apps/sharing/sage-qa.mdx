import { SageSupportLinkWizard } from '@/components/SageSupportLinkWizard'
...
<Properties>
	<Property name="devProjectId" type="number" required={true}>
        Links your Support Link to your Sage Developer project, used for analytics and behavior.
	</Property>
	<Property name="devReturnURI" type="string">
