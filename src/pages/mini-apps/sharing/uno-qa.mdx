...
function getUnoDeeplinkUrl(
  ...
  let path = `?tab=swap&fromToken=${fromToken}&toToken=${toToken}&amount=${amount}`;
  if (referrerAppId) {
...
```
https://worldcoin.org/mini-app?app_id=app_282f12de8a6524fed41b02ff37bc29e6&path=%3Ftab%3Dswap%26fromToken%3D0x79A02482A880bCE3F13e09Da970dC34db4CD24d1%26toToken%3D0x4200000000000000000000000000000000000006%26amount%3D1234500
```
