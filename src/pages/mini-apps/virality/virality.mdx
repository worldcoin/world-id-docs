...
In the developer portal, you can specify a meta tag image that will be used when your app is shared on
social platforms. If the image is not set, we fallback to your first showcase image.
The updated metatag will start showing up 1 hour after your app is approved. Moreover, the images can be localized, like all the other images.
