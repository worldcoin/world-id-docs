...
Fastest way to integrate and use World ID. The instructions below apply to both Sign in with World ID and Anonymous Actions.
...
- Select whether you want to run this action cloud-based or on-chain.
...
5. Install the [JS widget](/js/) in your frontend app/dapp.
