...
1. Sign up to the [Developer Portal](https://developer.worldcoin.org) and create your first [action](/about/protocol#what-are-actions).
...
### Import and render the World ID widget
