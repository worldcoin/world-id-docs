...
<Note>
	Most use cases use the **cloud** engine. Select **on-chain only** if you are using a **smart contract** to verify a
	user's World ID.
</Note>
...
<Tabs>
  ...
  <TabItem label="Anonymous Actions">
    ...
    <CodeGroup title="API Verification" tag="POST" label="/api/v1/verify/app_GBkZ1KlVUdFTjeMXskrX">
