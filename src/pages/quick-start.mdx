...
Fastest way to integrate and use World ID. Find instructions below forth both **Sign in with World ID** and **Anonymous Actions**.
...
<Callout type="note">
  ...
  campaign 1 will always be unliked from users from campaign 2, providing higher
  privacy.
</Callout>
