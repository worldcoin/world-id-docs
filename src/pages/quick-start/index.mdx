...
4. Note your App ID (also called the Client ID). It looks something like {/* cSpell:disable */}`app_GBkZ1KlVUdFTjeMXskrX`{/* cSpell:enable */}. For Sign In with Worldcoin, you should also note your Client Secret, which is found alongside the Client ID in the **Sign In** tab.
...
5. Follow our guides specific to your use case:
    <Tabs>
        ...
        <TabItem value="cloud" label="Cloud Anonymous Actions">
            <Note>
        ...
        <TabItem value="on-chain" label="On-Chain Anonymous Actions">
            <Note>
