...
<table>
	...
	<tbody>
    	...
    	<tr>
			...
			<td className="align-middle">~5 Minutes after Ethereum Goerli</td>
		</tr>
	</tbody>
</table>
...
<Properties>
	...
	<Property name="externalNullifierHash" type="uint256" required={true}>
		...
		<Note>Read more about the External Nullifier in [Protocol Internals](/further-reading/protocol-internals#external-nullifier).</Note>
	</Property>
...
Here's an example function doing the above. You can also use the [World ID starter kits](/id/on-chain) to get started with sybil resistance.
