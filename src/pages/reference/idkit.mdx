...
<Properties>
	...
	<Property name="enableTelemetry" type="boolean" defaultValue="false">
...
The React package comes bundled with optional **opt-in** telemetry. Receiving these telemetry events from the package helps us understand how the product is being used so it can be improved.
