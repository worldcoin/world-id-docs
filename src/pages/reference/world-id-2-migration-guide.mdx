...
<Note>Read more about World ID Device and important considerations for your application in the [Verification Levels documentation](/id/verification-levels).</Note>
