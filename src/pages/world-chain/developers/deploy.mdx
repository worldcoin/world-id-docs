...
<Note>
	Never share your private key with anyone and always make sure that you don't upload them to code versioning tools
	like Git and hosting platforms like GitHub. Research best practices for private key management in order to avoid
	loss of funds.
</Note>
...
group chat on [Telegram](https://t.me/worlddevelopersupport) or [Discord](https://discord.gg/worldcoin).
