...
[Coinbase Onramp](https://www.coinbase.com/developer-platform/products/onramp) makes it easy for app and wallet users to buy WLD directly with fiat, supporting debit card, Apple Pay, and ACH transactions. U.S. users can purchase up to $500/week without a Coinbase account—just SMS verification required. Off-ramping is just as simple, allowing users to cash out crypto back to fiat seamlessly. Built for fast onboarding and smooth exits, Coinbase Onramp powers a frictionless experience in the Worldcoin ecosystem. Get started: https://docs.cdp.coinbase.com/onramp/docs/welcome/
