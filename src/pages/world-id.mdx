...
World ID can be easily integrated into both cloud and on chain apps. Users, with a valid World ID, can anonymously verify in seconds they are a unique human through a World ID compatible wallet, like [World App](https://worldcoin.org/download).
