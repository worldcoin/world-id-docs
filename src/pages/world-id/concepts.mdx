...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td className="align-middle"><img src="/icons/credential-orb.svg" alt="" className="h-8 w-8 m-0 mr-2 inline" />NFC</td>
      <td className="align-middle">High</td>
      <td className="align-middle">Biometric verification via NFC.</td>
    </tr>
    <tr>
      <td className="flex items-center"><img src="/icons/credential-orb.svg" alt="" className="h-8 w-8 m-0 mr-2 inline" />Secure NFC</td>
      <td className="align-middle">High</td>
      <td className="align-middle">Enhanced biometric verification via NFC with additional security measures,</td>
    </tr>
    <tr>
