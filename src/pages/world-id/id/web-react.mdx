...
You can localize the IDKit modal by passing the `language` prop. 
By default it will try to detect the user's browser language via the `navigator.language` property.
