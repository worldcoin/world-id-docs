...
This widget will prompt the user to scan a QR code that will redirect him to the World App to verify.

<Note>
	If you want to use IDKit in Vanilla JS application refer to this
	[example](https://github.com/worldcoin/idkit-js/tree/main/examples/with-html) using `@worldcoin/idkit-standalone`
	[package](https://www.npmjs.com/package/@worldcoin/idkit-standalone).
</Note>
