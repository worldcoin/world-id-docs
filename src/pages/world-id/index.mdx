<span className="mb-9 mt-4 flex rounded-3xl bg-gray-900 bg-[url('/images/docs/announcement-texture.png')] bg-repeat px-8 py-1 text-white">
	...
	<span className="flex items-center justify-end pl-6">
		<a
			className="m-0 rounded-lg bg-gray-900 px-4 py-2 text-white no-underline outline outline-white hover:no-underline"
			href="/world-id/reference/world-id-2-migration-guide"
			target="_blank"
		>
			<p className="m-0 whitespace-nowrap p-0 font-medium hover:no-underline">Migration Guide</p>
		</a>
	</span>
	<span className="flex items-center justify-end pl-6">
		<a
...
# World ID {{ className: 'text-5xl pt-24' }}
